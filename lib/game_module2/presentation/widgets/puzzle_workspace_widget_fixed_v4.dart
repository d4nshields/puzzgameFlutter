...
/// 
/// Fixed version 4: Direct placement using workspace controller
...
class _PuzzleWorkspaceWidgetState extends State<PuzzleWorkspaceWidget> {
  ...
  void _placePieceDirectly(PuzzlePiece piece, int row, int col) {
    setState(() {
      ...
      // Create the correct position coordinate
      ...
      // Use the workspace's movePiece method directly
      ...
      if (result.type == MoveResultType.snapped) {
        ...
        print('Failed to snap piece: ${result.type}');
      }
    });
  }
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text(
              'Each piece shows its position:\nR = Row (1-${widget.gameSession.gridSize})\nC = Column (1-${widget.gameSession.gridSize})',
